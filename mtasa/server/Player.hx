...
extern class Player extends Element {
  ...
  **/
  @:overload(function(Red: Int, Green: Int, Blue: Int): Bool {})  // {} is required
  @:overload(function(Reset: Bool): Bool {})  // {} is required
  public function setNametagColor(): Bool;  // R,G,B or Bool
