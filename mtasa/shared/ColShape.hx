...
extern class ColShape extends Element{
  ...
  **/
  public static function Polygon(fX: Float, fY: Float, fX1: Float, fY1: Float, fX2: Float, fY2: Float, fX3: Float, fY3: Float, points: haxe.extern.Rest<Float>): ColShape;
  ...
  **/
  public function getElementsWithin(?elemType: String): lua.Table<Int,Element>;
}
