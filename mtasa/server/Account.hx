...
extern class Account{
    ...
    **/
    ...
    /**
    This variable retrieves the name of an account.
    **/
    ...
    **/
    ...
    /**
    This variable returns the player element that is currently using a specified account, i.e. is logged into it. Only one player can use an account at a time.
    **/
    ...
    **/
    ...
    /**
    This variable returns the last serial that logged onto the specified account.
    **/
    ...
    **/
    ...
    /**
    This variable checks to see if an account is a guest account. A guest account is an account automatically created for a user when they join the server and deleted when they quit or login to another account. Data stored in a guest account is not stored after the player has left the server. As a consequence, this variable will check if a player is logged in or not.
    **/
    ...
    **/
    ...
    passwordType: can be "plaintext", "sha256", or "md5"
    **/
